    ...
    return (
        <section className="bg-primary-950">
            <div className="relative isolate overflow-hidden">
                ...
                />
                <div className="mx-auto min-h-[300px] max-w-4xl px-6 py-32 sm:min-h-[400px] sm:py-48 lg:min-h-[500px] lg:px-0 lg:py-24">
                    <div className="text-center">
                        <h2 className="font-display text-4xl font-semibold tracking-tight text-white md:text-5xl lg:max-w-4xl lg:text-6xl">
                            {Header}
                        </h2>
