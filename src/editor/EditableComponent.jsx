...
export function EditableComponent(props) {
    ...
    return (
        <div className="edit-component-wrapper group relative">
            ...
            <div className="pointer-events-none invisible absolute inset-0 z-20 flex shrink-0 items-center border-b border-t border-dashed border-gray-300 group-hover:visible">
                {is_movable && (
                    <button
                        className="pointer-events-auto absolute -top-5 left-1/2 z-40 -translate-x-1/2 transform rounded bg-black px-4 py-2 text-white opacity-100 hover:bg-gray-900"
                        onClick={() => {
                ...
                {is_movable && (
                    <button
                        className="pointer-events-auto absolute -bottom-5 left-1/2 z-40 -translate-x-1/2 transform rounded bg-black px-4 py-2 text-white opacity-100 hover:bg-gray-900"
                        onClick={() => {
                ...
                <div className="pointer-events-auto ml-8 inline-flex shrink-0 flex-col items-center space-y-4 rounded bg-black/50 p-8">
                    {is_movable && (
                        <button
                    ...
                    {is_movable && (
                        <button
                            className="pointer-events-auto rounded bg-black p-4 text-white opacity-100 hover:bg-gray-900"
                            title="Move Down"
                            onClick={() =>
                                editor.components.move({
                                    index,
                    ...
                    <button
                        className="pointer-events-auto rounded bg-blue-500 p-4 text-white opacity-100 hover:bg-blue-600 disabled:bg-neutral-400"
                        title={'Edit'}
                    ...
                    {is_movable && (
                        <button
                            className="pointer-events-auto rounded bg-red-500 p-4 text-white opacity-100 hover:bg-red-600"
                            title="Delete"
