...
export default function Team(props) {
    ...
    return (
        <section
            className="editable-component relative isolate overflow-hidden bg-secondary-100 px-6 py-24 sm:py-32 lg:px-8"
            data-json="team"
        >
                    ...
                    {renderedPeople.map(({ Person }) => (
                        <li key={Person.Name}>
                            <img
                                ...
                                loading="lazy"
                            />
                            <h3 className="mt-6 text-center font-display text-base font-semibold leading-7 tracking-tight text-primary-700">
                                {Person.Name}
                            </h3>
