...
export function EditorContextProvider(props) {
    ...
    const [is_site_settings_open, setIsSiteSettingsOpen] = useState(false)
    ...
    const [page_settings_open_mode, setIsPageSettingsOpen] = useState(null)
    ...
    /**
     * Determines whether the site settings are open or not
     * @returns {boolean} - Whether the site settings are open or not
     */
    const isSiteSettingsVisible = () => {
        return is_site_settings_open
    }

    /**
     * Opens the site settings and closes any other open editor
     */
    const handleOpenSiteSettings = () => {
        setIsSiteSettingsOpen(true)
        setComponentEditorOpenIndex(null)
        setIsPageSettingsOpen(null)
    }

    /**
     * Closes the site settings
     */
    ...
    /**
     * Determines whether the page settings are open or not
     * @returns {boolean} - Whether the page settings are open or not
     */
    const isPageSettingsVisible = ({ mode }) => {
        return page_settings_open_mode === mode
    }

    /**
     * Opens the page settings and closes any other open editor\
     * @param {'settings' | 'add'} arg.mode - The mode of the page settings
     */
    const handleOpenPageSettings = ({ mode }) => {
        setIsPageSettingsOpen(mode)
        setComponentEditorOpenIndex(null)
        setIsSiteSettingsOpen(false)
    }

    /**
     * Closes the page settings
     */
    ...
    const handleAddPage = async ({ page_type, path }) => {
        ...
        try {
            ...
            setAddingPage(false)
            if (page_settings_open_mode === 'add') {
        ...
        <EditorContext.Provider
            value={{
                global: {
                    ...
                    open: handleOpenSiteSettings,
                    close: handleCloseSiteSettings,
                ...
                page: {
                    ...
                    open: handleOpenPageSettings,
                    close: handleClosePageSettings,
                    visible: isPageSettingsVisible,
                },
                components: {
                    data: components,
